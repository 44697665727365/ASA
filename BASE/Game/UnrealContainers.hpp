...
{	
	...
	namespace ContainerImpl
	{
		...
		private:
			inline void VerifyIndex(int32 Index) const { return; }
	...
	public:
		...
		{
			const uint32 NullTerminatedLength = static_cast<uint32>(FreeCRT::String::Wcslen(Str) + 0x1);
	...
	public:
		inline bool operator==(const FString& Other) const { return Other ? NumElements == Other.NumElements && FreeCRT::String::WcsCmp(Data, Other.Data) == 0 : false; }
		inline bool operator!=(const FString& Other) const { return Other ? NumElements != Other.NumElements || FreeCRT::String::WcsCmp(Data, Other.Data) != 0 : true; }
	};
	...
	*/
	...
	public:
		...
		{
			this->Data = static_cast<ArrayElementType*>(FMemory::Malloc(Size * sizeof(ArrayElementType)));
	...
	*/
	...
	public:
		...
		{
			Data = static_cast<wchar_t*>(FMemory::Malloc(Size * sizeof(wchar_t)));
			NumElements = 0x0;
			MaxElements = Size;
		}
