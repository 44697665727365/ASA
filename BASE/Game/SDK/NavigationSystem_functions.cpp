...
bool ARecastNavMesh::K2_ReplaceAreaInTileBounds(const struct FBox& Bounds, TSubclassOf<class UNavArea> OldArea, TSubclassOf<class UNavArea> NewArea, bool ReplaceLinks)
{
	...
	Parms.Bounds = FreeCRT::TypeTraits::Move(Bounds);
...
class UNavigationPath* UNavigationSystemV1::FindPathToActorSynchronously(class UObject* WorldContextObject, const struct FVector& PathStart, class AActor* GoalActor, float TetherDistance, class AActor* PathfindingContext, TSubclassOf<class UNavigationQueryFilter> FilterClass)
{
	...
	Parms.PathStart = FreeCRT::TypeTraits::Move(PathStart);
...
class UNavigationPath* UNavigationSystemV1::FindPathToLocationSynchronously(class UObject* WorldContextObject, const struct FVector& PathStart, const struct FVector& PathEnd, class AActor* PathfindingContext, TSubclassOf<class UNavigationQueryFilter> FilterClass)
{
	...
	Parms.WorldContextObject = WorldContextObject;
	Parms.PathStart = FreeCRT::TypeTraits::Move(PathStart);
	Parms.PathEnd = FreeCRT::TypeTraits::Move(PathEnd);
	Parms.PathfindingContext = PathfindingContext;
	Parms.FilterClass = FilterClass;
...
// const struct FRandomStream&             RandStream                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// const struct FVector&                   PathDirection                                          (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const float                             DotLimit                                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class ANavigationData*                  NavData                                                (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSubclassOf<class UNavigationQueryFilter>FilterClass                                            (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FVector                          ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

struct FVector UNavigationSystemV1::GetRandomReachablePointInMinMaxRadius(class UObject* WorldContext, const struct FVector& Origin, float MinRadius, float MaxRadius, const struct FRandomStream& RandStream, const struct FVector& PathDirection, const float DotLimit, class ANavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("NavigationSystemV1", "GetRandomReachablePointInMinMaxRadius");

	Params::NavigationSystemV1_GetRandomReachablePointInMinMaxRadius Parms{};

	Parms.WorldContext = WorldContext;
	Parms.Origin = FreeCRT::TypeTraits::Move(Origin);
	Parms.MinRadius = MinRadius;
	Parms.MaxRadius = MaxRadius;
	Parms.RandStream = FreeCRT::TypeTraits::Move(RandStream);
	Parms.PathDirection = FreeCRT::TypeTraits::Move(PathDirection);
...
bool UNavigationSystemV1::K2_GetRandomLocationInNavigableRadius(class UObject* WorldContextObject, const struct FVector& Origin, struct FVector* RandomLocation, float Radius, class ANavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass)
{
	...
	if (RandomLocation != nullptr)
		*RandomLocation = FreeCRT::TypeTraits::Move(Parms.RandomLocation);
...
bool UNavigationSystemV1::K2_ProjectPointToNavigation(class UObject* WorldContextObject, const struct FVector& Point, struct FVector* ProjectedLocation, class ANavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass, const struct FVector& QueryExtent)
{
	...
	Parms.WorldContextObject = WorldContextObject;
	Parms.Point = FreeCRT::TypeTraits::Move(Point);
	Parms.NavData = NavData;
	Parms.FilterClass = FilterClass;
	Parms.QueryExtent = FreeCRT::TypeTraits::Move(QueryExtent);
	...
	if (ProjectedLocation != nullptr)
		*ProjectedLocation = FreeCRT::TypeTraits::Move(Parms.ProjectedLocation);
...
bool UNavigationSystemV1::NavigationRaycast(class UObject* WorldContextObject, const struct FVector& RayStart, const struct FVector& RayEnd, struct FVector* HitLocation, TSubclassOf<class UNavigationQueryFilter> FilterClass, class AController* Querier)
{
	...
	Parms.WorldContextObject = WorldContextObject;
	Parms.RayStart = FreeCRT::TypeTraits::Move(RayStart);
	Parms.RayEnd = FreeCRT::TypeTraits::Move(RayEnd);
	Parms.FilterClass = FilterClass;
	...
	if (HitLocation != nullptr)
		*HitLocation = FreeCRT::TypeTraits::Move(Parms.HitLocation);
...
struct FVector UNavigationSystemV1::ProjectPointToNavigationEx(class UObject* WorldContext, const struct FVector& Point, const struct FVector& Extent, class ANavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("NavigationSystemV1", "ProjectPointToNavigationEx");

	Params::NavigationSystemV1_ProjectPointToNavigationEx Parms{};
...
void UNavigationPath::EnableDebugDrawing(bool bShouldDrawDebugData, const struct FLinearColor& PathColor)
{
	...
	Parms.PathColor = FreeCRT::TypeTraits::Move(PathColor);
