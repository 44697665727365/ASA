...
namespace Offsets
{
	inline uint64_t GObjects          = 0x00000000;
	inline uint64_t AppendString      = 0x00000000;
	inline uint64_t GNames            = 0x00000000;
	inline uint64_t GWorld            = 0x00000000;
	inline uint64_t ProcessEvent      = 0x00000000;
	inline uint64_t StaticFindObject  = 0x00000000;
...
private:
	...
	{
		GObjectsAddress = reinterpret_cast<void*>(Offsets::GObjects);
	}
...
public:
	...
	{
		AppendString = reinterpret_cast<void*>(Offsets::AppendString);
	}
	...
	{
		FAllocatedString TempString(1024);
