...
class IPrimalWidgetInterface final
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"PrimalWidgetInterface">();
	}
	static class IPrimalWidgetInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IPrimalWidgetInterface>();
	}
