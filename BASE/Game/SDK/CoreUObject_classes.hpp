...
public:
	...
	static inline void* StaticFindObjectFn = nullptr;
public:
...
public:
	...
	template<typename T>
	static T* StaticFindObject(const wchar_t* Name)
	{
		auto Fn = reinterpret_cast<UObject * (__fastcall*)(UObject*, UObject*, const wchar_t*, bool)>(StaticFindObjectFn);

		return static_cast<T*>(Fn((UObject*)nullptr, (UObject*)nullptr, Name, false));
	}
...
class alignas(0x08) UClass : public UStruct
{
public:
...
{
public:
	uint8                                         Pad_228[0x88];                                     // 0x0228(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
