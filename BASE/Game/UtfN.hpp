...
namespace UtfN
{
		...
		namespace Iterator
		{
			...
			public:
				...
				template<typename container_type,
					typename = decltype(std::begin(FreeCRT::TypeTraits::Declval<container_type>())), // Has begin
					typename = decltype(std::end(FreeCRT::TypeTraits::Declval<container_type>())),   // Has end
					typename iterator_deref_type = decltype(*std::end(FreeCRT::TypeTraits::Declval<container_type>())), // Iterator can be dereferenced
	...
	public:
		...
		template<typename char_type, typename = decltype(ParseUtf8CharFromStr(FreeCRT::TypeTraits::Declval<const char_type*>()))>
	...
	public:
		...
		template<typename char_type, typename = decltype(ParseUtf16CharFromStr(FreeCRT::TypeTraits::Declval<const char_type*>()))>
		UTF_CONSTEXPR utf_char(const char_type* SingleCharString) noexcept;
	...
	public:
		...
		template<typename char_type, typename = decltype(ParseUtf32CharFromStr(FreeCRT::TypeTraits::Declval<const char_type*>()))>
		UTF_CONSTEXPR utf_char(const char_type* SingleCharString) noexcept;
	...
	template<
		...
		typename iterator_deref_type = decltype(*FreeCRT::TypeTraits::Declval<codepoint_iterator_type>()), // Iterator can be dereferenced
	...
	template<typename utf8_char_string,
		...
		typename target_char_type = typename std::decay<decltype(*std::begin(FreeCRT::TypeTraits::Declval<utf8_char_string>()))>::type
	>
	...
	template<typename utf8_char_string, typename utf16_char_string,
		typename inner_iterator = decltype(std::begin(FreeCRT::TypeTraits::Declval<const utf16_char_string>())),
	...
	template<typename utf8_char_string, typename utf32_char_string,
		typename inner_iterator = decltype(std::begin(FreeCRT::TypeTraits::Declval<utf32_char_string>())),
	...
	template<typename utf16_char_string,
		typename inner_iterator,
		typename target_char_type = typename std::decay<decltype(*std::begin(FreeCRT::TypeTraits::Declval<utf16_char_string>()))>::type
	>
	UTF_CONSTEXPR20 UTF_NODISCARD
	...
	template<typename utf16_char_string, typename utf8_char_string,
		typename inner_iterator = decltype(std::begin(FreeCRT::TypeTraits::Declval<utf8_char_string>())),
	...
	template<typename utf32_char_string,
		typename inner_iterator,
		typename target_char_type = typename std::decay<decltype(*std::begin(FreeCRT::TypeTraits::Declval<utf32_char_string>()))>::type
	>
	UTF_CONSTEXPR20 UTF_NODISCARD
	...
	template<typename wstring_type = std::wstring, typename string_type = std::string,
		typename = decltype(std::begin(FreeCRT::TypeTraits::Declval<wstring_type>())), // has 'begin()'
		typename = decltype(std::end(FreeCRT::TypeTraits::Declval<wstring_type>()))    // has 'end()'
	>
	UTF_CONSTEXPR20 UTF_NODISCARD
		string_type WStringToString(const wstring_type& WideString)
	{
		using char_type = typename std::decay<decltype(*std::begin(FreeCRT::TypeTraits::Declval<wstring_type>()))>::type;
	...
	template<typename string_type = std::string, typename wstring_type = std::wstring,
		typename = decltype(std::begin(FreeCRT::TypeTraits::Declval<string_type>())), // has 'begin()'
		typename = decltype(std::end(FreeCRT::TypeTraits::Declval<string_type>()))    // has 'end()'
	>
	UTF_CONSTEXPR20 UTF_NODISCARD
